...
public class NaturalOrderObjComparator implements Comparator<Map>
{
    ...
    {
        String a = o1.getOrDefault(this.props, "").toString();
        String b = o2.getOrDefault(this.props, "").toString();
